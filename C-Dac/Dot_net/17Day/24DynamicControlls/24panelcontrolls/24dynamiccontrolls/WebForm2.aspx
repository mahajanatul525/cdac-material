<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="_24dynamiccontrolls.WebForm2" %>
...
<asp:Panel ID="AdminPanel" runat="server" BackColor="#FFCCFF" BorderStyle="Solid">
<table>
    <tr>
        <td colspan="2">
...
<asp:Panel ID="NonAdminPanel" runat="server" BackColor="#FFFFCC" BorderStyle="Double">
<table>
    <tr>
        <td colspan="2">
